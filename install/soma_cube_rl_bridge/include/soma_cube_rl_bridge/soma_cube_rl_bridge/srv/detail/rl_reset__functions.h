...
#ifndef SOMA_CUBE_RL_BRIDGE__SRV__DETAIL__RL_RESET__FUNCTIONS_H_
#define SOMA_CUBE_RL_BRIDGE__SRV__DETAIL__RL_RESET__FUNCTIONS_H_
...
/// Initialize srv/RLReset message.
/**
...
/// Create srv/RLReset message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * soma_cube_rl_bridge__srv__RLReset_Request__init().
...
/// Destroy srv/RLReset message.
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLReset_Request__fini()
...
/// Check for srv/RLReset message equality.
/**
...
/// Initialize array of srv/RLReset messages.
/**
...
/// Finalize array of srv/RLReset messages.
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLReset_Request__fini()
...
/// Create array of srv/RLReset messages.
/**
 * It allocates the memory for the array and calls
 * soma_cube_rl_bridge__srv__RLReset_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RLReset messages.
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLReset_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RLReset message array equality.
/**
...
/// Copy an array of srv/RLReset messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * soma_cube_rl_bridge__srv__RLReset_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_soma_cube_rl_bridge
...
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLReset_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_soma_cube_rl_bridge
...
/**
 * It allocates the memory for the array and calls
 * soma_cube_rl_bridge__srv__RLReset_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_soma_cube_rl_bridge
...
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLReset_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SOMA_CUBE_RL_BRIDGE__SRV__DETAIL__RL_RESET__FUNCTIONS_H_

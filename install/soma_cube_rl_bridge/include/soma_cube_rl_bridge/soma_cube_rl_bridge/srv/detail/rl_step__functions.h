...
#ifndef SOMA_CUBE_RL_BRIDGE__SRV__DETAIL__RL_STEP__FUNCTIONS_H_
#define SOMA_CUBE_RL_BRIDGE__SRV__DETAIL__RL_STEP__FUNCTIONS_H_
...
/// Create srv/RLStep message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * soma_cube_rl_bridge__srv__RLStep_Request__init().
...
/// Destroy srv/RLStep message.
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLStep_Request__fini()
...
/// Check for srv/RLStep message equality.
/**
...
/// Initialize array of srv/RLStep messages.
/**
...
/// Finalize array of srv/RLStep messages.
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLStep_Request__fini()
...
/// Create array of srv/RLStep messages.
/**
 * It allocates the memory for the array and calls
 * soma_cube_rl_bridge__srv__RLStep_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RLStep messages.
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLStep_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RLStep message array equality.
/**
...
/// Copy an array of srv/RLStep messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * soma_cube_rl_bridge__srv__RLStep_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_soma_cube_rl_bridge
...
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLStep_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_soma_cube_rl_bridge
...
/**
 * It allocates the memory for the array and calls
 * soma_cube_rl_bridge__srv__RLStep_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_soma_cube_rl_bridge
...
/**
 * It calls
 * soma_cube_rl_bridge__srv__RLStep_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SOMA_CUBE_RL_BRIDGE__SRV__DETAIL__RL_STEP__FUNCTIONS_H_

...
static const _SafetyState_type_support_symbol_names_t _SafetyState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, soma_cube_rl_bridge, msg, SafetyState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, soma_cube_rl_bridge, msg, SafetyState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, soma_cube_rl_bridge, msg, SafetyState)() {
  return &::soma_cube_rl_bridge::msg::rosidl_typesupport_c::SafetyState_message_type_support_handle;
}

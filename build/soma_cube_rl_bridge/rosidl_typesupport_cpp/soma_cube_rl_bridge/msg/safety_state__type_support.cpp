...
static const _SafetyState_type_support_symbol_names_t _SafetyState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, soma_cube_rl_bridge, msg, SafetyState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, soma_cube_rl_bridge, msg, SafetyState)),
  }
};
...
{
  return &::soma_cube_rl_bridge::msg::rosidl_typesupport_cpp::SafetyState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, soma_cube_rl_bridge, msg, SafetyState)() {
  return get_message_type_support_handle<soma_cube_rl_bridge::msg::SafetyState>();
}

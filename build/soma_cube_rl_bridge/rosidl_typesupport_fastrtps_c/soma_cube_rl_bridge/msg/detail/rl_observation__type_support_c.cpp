...
#include "soma_cube_rl_bridge/msg/detail/rl_observation__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // tcp_pose
#include "rosidl_runtime_c/primitives_sequence.h"  // joint_positions, joint_velocities, tool_force
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // joint_positions, joint_velocities, tool_force
...
using _RLObservation__ros_msg_type = soma_cube_rl_bridge__msg__RLObservation;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RLObservation__ros_msg_type * ros_message = static_cast<const _RLObservation__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  {
    size_t size = ros_message->tool_force.size;
    auto array_ptr = ros_message->tool_force.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: gripper_status
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RLObservation__ros_msg_type * ros_message = static_cast<_RLObservation__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: tool_force
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->tool_force.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->tool_force);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->tool_force, size)) {
      fprintf(stderr, "failed to create array for field 'tool_force'");
      return false;
    }
    auto array_ptr = ros_message->tool_force.data;
    cdr.deserializeArray(array_ptr, size);
...
size_t get_serialized_size_soma_cube_rl_bridge__msg__RLObservation(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RLObservation__ros_msg_type * ros_message = static_cast<const _RLObservation__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RLObservation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_soma_cube_rl_bridge__msg__RLObservation(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_soma_cube_rl_bridge
size_t max_serialized_size_soma_cube_rl_bridge__msg__RLObservation(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = soma_cube_rl_bridge__msg__RLObservation;
    is_plain =
      (
...
static size_t _RLObservation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_soma_cube_rl_bridge__msg__RLObservation(
...
static message_type_support_callbacks_t __callbacks_RLObservation = {
...
static rosidl_message_type_support_t _RLObservation__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RLObservation,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, soma_cube_rl_bridge, msg, RLObservation)() {
  return &_RLObservation__type_support;
}
